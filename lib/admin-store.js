...
function sanitizeSettings(settings) {
  ...
  const effectivePinterestAccessToken = preferEnvironmentCredential(
    config.pinterest.accessToken,
    settings.pinterest.accessToken
  );
  const effectivePinterestRefreshToken = preferEnvironmentCredential(
    config.pinterest.refreshToken,
    settings.pinterest.refreshToken
  );
  ...
  return {
    config: {
      ...
      pinterest: {
        ...
        accessToken: preferEnvironmentCredential(
          config.pinterest.accessToken,
          privateSettings.pinterest.accessToken
        ),
        refreshToken: preferEnvironmentCredential(
          config.pinterest.refreshToken,
          privateSettings.pinterest.refreshToken
        ),
