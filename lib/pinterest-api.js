...
export async function createPinterestBoard(config, name, { privacy = "PUBLIC" } = {}) {
...
export async function updatePinterestBoard(config, boardId, input) {
  ...
  if (Object.prototype.hasOwnProperty.call(input, "name")) {
    body.name = normalizeOptionalString(input.name);
  }
...
export async function updatePinterestBoardSection(config, boardId, sectionId, input) {
  const body = {};
...
export async function updatePinterestPin(config, pinId, input) {
  ...
  if (Object.prototype.hasOwnProperty.call(input, "link")) {
    body.link = normalizeOptionalString(input.link);
  }
