...
function comparePinterestItems(left, right) {
  return (
    String(left.season || "").localeCompare(String(right.season || ""), "it", {
      numeric: true,
      sensitivity: "base"
    }) ||
    String(left.assetType || "").localeCompare(String(right.assetType || ""), "it", {
      numeric: true,
      sensitivity: "base"
    }) ||
    String(left.collection || "").localeCompare(String(right.collection || ""), "it", {
      numeric: true,
      sensitivity: "base"
    }) ||
    (left.detailSegments || []).join("/").localeCompare((right.detailSegments || []).join("/"), "it", {
      numeric: true,
      sensitivity: "base"
    }) ||
    String(left.sourceSubPath || "").localeCompare(String(right.sourceSubPath || ""), "it", {
      numeric: true,
      sensitivity: "base"
    }) ||
