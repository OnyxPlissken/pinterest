...
async function loadPinterestSelection({ subPaths = [], subPath = "", origin = "" } = {}) {
...
export async function previewPinterestSelection({ subPaths = [], subPath = "", origin = "", limit = 8 } = {}) {
  const selection = await loadPinterestSelection({ subPaths, subPath, origin });
...
export async function generatePinterestCsv({ subPaths = [], subPath = "", origin = "" } = {}) {
  const selection = await loadPinterestSelection({ subPaths, subPath, origin });
